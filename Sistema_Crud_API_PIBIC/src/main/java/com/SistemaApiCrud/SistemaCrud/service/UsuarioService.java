...
public class UsuarioService {
    ...
    private Usuario aplicarDados(UsuarioRequestDTO dto, Usuario usuario) {
    ...
    private void vincularPerfil(UsuarioRequestDTO dto, Usuario usuario) {
    ...
    private void validarSemPerfil(UsuarioRequestDTO dto) {
